...
from mediaarchiver.file_name_builder import FileNameBuilder, DefaultFileNameBuilder


class DownloadOrderGenerator:
    def __init__(self, base_url: str, path_directory_download: Path, list_article: List[Article],
    ...
    def create_coroutine(self, url: str, created_date_time: datetime) -> DownloadOrder:
        return DownloadOrder(url, SaveOrder(
